    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h2 class="box-title"> Data type Post Information </h2>
            </div>
            <!-- /.box-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <!-- <?php
                        ...
                        $queryForTuition = mysqli_query($con,$sqlForjava);
                        while($info = mysqli_fetch_array($queryForjava)) {
                        ?>
                        <tr>
                        <td><?php echo $serialNo;?></td>
                        <td><?php echo $info['cetegory']; ?></td>

                        <td><?php echo $info['questionupload']; ?></td>
